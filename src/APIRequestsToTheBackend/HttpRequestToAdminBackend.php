 ...
 *
 * @package Lasallesoftware\Libraryfrontend\APIRequestsToTheBackend\HttpRequestToAdminBackend
 */
trait HttpRequestToAdminBackend
{
     ...
     * @return string|null
     */
    public function getPageURLForPagination($frontEndRoute, $url = null)
    {
        if ((is_null($url)) || ($url == '')) {
            return null;
        }
